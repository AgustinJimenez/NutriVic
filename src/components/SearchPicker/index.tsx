        ...
        <>
            ...
            >
                ...
                >
                    <Card>
                        <Header>
                            <Title style={{ flex: 1, textAlignVertical: 'center' }}>{t(title)}</Title>
                            <Icon
                                type='AntDesign'
                                name='close'
                                onPress={() => {
                        ...
                        <View style={{ marginVertical: Platform.OS === 'android' ? 20 : 0 }}>
                            <SearchBar
                                ...
                                {listItems
                                    ...
                                    .map(({ label, value }: any, key: number) => {
                                        ...
                                        return (
                                            <TouchableOpacity
                                                ...
                                                onPress={() => {
                                                    if (type === 'single') {
                                                        ...
                                                        selectedValues = selectedValues.filter((val: any) => val !== value)
                                                    else if (type === 'multiple' && !isSelected) selectedValues.push(value)
                                            ...
                                            >
                                                <Text style={{ color: 'black', flex: 0.9, flexWrap: 'wrap' }}>{label}</Text>
                                                <View style={{ flex: 0.2, justifyContent: 'center', alignItems: 'center' }}>
                                                    <Icon name={iconName} type={iconType} style={{ color: brandPrimary }} />
                                                </View>
                                            </TouchableOpacity>
                                        )
                                    })}
